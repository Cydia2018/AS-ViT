...
class Block(nn.Module):
    ...
    def flops(self, num_tokens):
        ...
        attnout_flops = dim * dim * num_tokens
        mha_block_flops = kqv_flops + attn_flops + attnv_flops + attnout_flops
        # ffn_flops
        fc1_flops = dim * mlp_dim * num_tokens
        fc2_flops = dim * num_tokens * mlp_dim
        ffn_flops = fc1_flops + fc2_flops
...
class PatchEmbed(nn.Module):
    ...
    def flops(self):
        ...
        block_flops = self.num_patches * self.embed_dim * 3 * patch_size * patch_size
        return block_flops / 1e+9
...
class VisionTransformerDiffPruning(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 pruning_loc=None, token_ratio=None, accu=False, ema_accu=False, distill=False, viz_mode=False):
        """
        Args:
    ...
    def forward(self, x):
        ...
        if self.training:
            if self.distill:
                return x, features, prev_decision.detach(), out_pred_prob, total_flops, (flops_1stage, flops_2stage, flops_3stage, flops_4stage)
            else:
